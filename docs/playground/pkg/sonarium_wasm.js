...
export class RenderResult {
     ...
     */
    get channels() {
        const ret = wasm.renderresult_channels(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Duration in seconds.
     ...
     */
    get duration() {
        const ret = wasm.renderresult_duration(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get error() {
        const ret = wasm.renderresult_error(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    get layersJson() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.renderresult_layersJson(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get left() {
        const ret = wasm.renderresult_left(this.__wbg_ptr);
     ...
     */
    get ok() {
        const ret = wasm.renderresult_ok(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get right() {
        const ret = wasm.renderresult_right(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get sampleRate() {
        const ret = wasm.renderresult_sampleRate(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get spectrogramPng() {
        const ret = wasm.renderresult_spectrogramPng(this.__wbg_ptr);
    ...
    get statsJson() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.renderresult_statsJson(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get waveformPng() {
        const ret = wasm.renderresult_waveformPng(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
 ...
 */
export function render(graph_json) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sonarium_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
